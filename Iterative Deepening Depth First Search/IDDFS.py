...
def main():                                     #Main function accepting input from console	
    global initial_memory,process,starttime,minimumf,starttime1,initial_memory1
    ...
    initial_memory1 = process.memory_info().rss / 1024.0
...
def results1(tmp):                                           #print the results for misplaced
    ...
    print('Time Taken:',time_taken,'seconds')
    final_memory = process.memory_info().rss / 1024.0
    print('Memory used:',final_memory-initial_memory1,'KB')
